...
const getManagers = "SELECT employee.first_name || ' ' || employee.last_name AS name FROM employee";
const getRoleId = "SELECT role.id FROM role WHERE role.title = $1";
const getManagerId = "SELECT employee.id FROM employee WHERE employee.first_name || ' ' || employee.last_name = $1";
